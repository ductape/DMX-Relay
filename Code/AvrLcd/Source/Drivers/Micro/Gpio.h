...
#define LCD_CONTRAST        (1<<PINB1)
#define SET_LCD_CONTRAST    PORTB |= LCD_CONTRAST
#define CLEAR_LCD_CONTRAST  PORTB &= ~LCD_CONTRAST
#define TOGGLE_LCD_CONTRAST PINB = LCD_CONTRAST
